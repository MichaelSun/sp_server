...
import com.sp.domain.WapCanal

class AdminWapCanalController {
...
//        [wapCanalInstanceList: WapCanal.list(params), wapCanalInstanceTotal: WapCanal.count()]
    ...
    def create() {
        [wapCanalInstance: new WapCanal(params),pList:pList]
    }
...
//				}
		...
		wapCanalInstance.area=areaProp
    ...
    def edit(Long id) {
        ...
        [wapCanalInstance: wapCanalInstance,pList:pList]
    }
